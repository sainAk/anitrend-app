...
class StaffActivity : ActivityBase<StaffBase, BasePresenter>() {
    ...
    override fun onActivityReady() {
        val pageAdapter = StaffPageAdapter(supportFragmentManager, applicationContext)
        pageAdapter.setParams(viewModel.params)
        viewPager!!.adapter = pageAdapter
        viewPager!!.offscreenPageLimit = offScreenLimit + 1
    ...
    override fun makeRequest() {
        ...
        viewModel.requestData(KeyUtil.getSTAFF_BASE_REQ(), applicationContext)
    }
